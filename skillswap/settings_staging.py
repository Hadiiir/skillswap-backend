...
SECRET_KEY = config('SECRET_KEY', default='django-staging-secret-key-change-this')
...
DATABASES = {
    'default': {
        ...
        'USER': config('STAGING_DB_USER', default='skillswap_staging1'),
        'PASSWORD': config('STAGING_DB_PASSWORD', default='staging123'),
        'HOST': config('STAGING_DB_HOST', default='192.168.1.4'),
...
PAYMOB_API_KEY = config('PAYMOB_API_KEY', default='staging-paymob-key')
STRIPE_PUBLISHABLE_KEY = config('STRIPE_PUBLISHABLE_KEY', default='pk_test_staging')
STRIPE_SECRET_KEY = config('STRIPE_SECRET_KEY', default='sk_test_staging')
...
print("Using Staging settings with separate database on port 5432")
