...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'django_filters',  # تأكد من وجود هذا
    'accounts',
    'skills',
    'points',
    'chat',
...
ROOT_URLCONF = 'skillswap.urls_simple'
...
# REST Framework - إعدادات محسنة للفلاتر
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': [
        ...
        'rest_framework.renderers.BrowsableAPIRenderer',  # للواجهة التفاعلية
    ],
}
...
DJANGO_FILTERS_STRICT_LOOKUP = False
